...
export function showHelp(): void {
  ...
  card.innerHTML = `
    ...
    <h3>🎁 보상 카드</h3>
    <ul>
      <li>점수가 <b>일정선(50 → 150 → 300 …)</b>을 넘으면 <b>카드 2장</b>이 화면 중앙에 뜬다 → <b>1장 선택</b>. 선택하는 동안 <b>시간이 멈춘다</b>.</li>
      <li><b>버프카드</b>: 해당 <b>말 종류 전체</b>를 영구 강화(사 2칸, 마 점프, 상 짓밟기, 포 보행, 차 관통, 궁성 결계).</li>
      <li><b>리젠카드</b>: <b>잃어버린 내 말</b>을 <b>원래 자리</b>에 되살린다(예: '좌측 마'). 원래 자리가 비어 있어야 하며, 보유 중인 버프도 함께 적용된다.</li>
      <li>보통 <b>버프 1장 + 리젠 1장</b>이 함께 뜬다. 처치·박자로 <b>점수를 빨리 쌓을수록</b> 카드를 빨리 받는다.</li>
    </ul>
    <h3>✨ 특수기능 (티켓 소모)</h3>
    <ul>
...
export function showIntroIfFirst(onStart: () => void): void {
  ...
  card.innerHTML = `
    ...
    <p>점수가 일정선을 넘으면 <b>🎁 보상 카드 2장</b>이 떠요 → <b>1장 선택</b>해서 내 말을 강화!</p>
